...
<body>
  ...
  <!-- Petunjuk Penempatan Script -->
  <!--
    Simpan file ini dengan nama "index.html"
    dan tempatkan di dalam folder situs Anda.
    Jika Anda menggunakan layanan seperti Netlify, Vercel, atau GitHub Pages,
    cukup unggah file ini ke repositori/public folder Anda.
  -->
</body>
</html>#
